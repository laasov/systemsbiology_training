...
$$\frac{d\:N_h}{d\:t}=r\big(1-\frac{N(t)}{C}\big)N(t)-\beta EN(t)$$

Where the rate of change of popultation size is also a function of both, the number of predators and the size of the population. However, $E$ could arguably be a function of $t$ as well, yielding a final form

$$\frac{d\:N_h}{d\:t}=r\big(1-\frac{N(t)}{C}\big)N(t)-\beta E(t)N(t)$$
...
$$r\big(1-\frac{N(t)}{C}\big)N(t)-\beta EN(t) = 0$$
